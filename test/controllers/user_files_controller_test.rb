...
class UserFilesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_file" do
    assert_difference('UserFile.count') do
      post user_files_url, params: { user_file: { folder_path: @user_file.folder_path, name: @user_file.name, service_file_id: @user_file.service_file_id } }, as: :json
    end
  ...
  test "should update user_file" do
    patch user_file_url(@user_file), params: { user_file: { folder_path: @user_file.folder_path, name: @user_file.name, service_file_id: @user_file.service_file_id } }, as: :json
    assert_response 200
  end
